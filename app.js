...
app.get('/contacts', function(req, res) { //Contact us Page
...
app.post('/compose', function(req, res) { //Adding new post or article
    const post = {
...
app.get('/posts/:postName', function(req, res) { //Displying a post on new page
